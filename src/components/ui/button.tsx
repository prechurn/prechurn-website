  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground shadow-medium hover:shadow-strong hover:bg-primary/90 active:scale-[0.98] text-base font-semibold",
        "hero-secondary": "bg-card text-foreground border border-border shadow-soft hover:shadow-medium hover:bg-secondary text-base font-medium",
        accent: "bg-accent text-accent-foreground shadow-soft hover:shadow-medium hover:bg-accent/90 active:scale-[0.98]",
      },
      size: {
